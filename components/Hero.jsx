...
const Hero = () => {
  return (
    <div className=" justify-center items-center rounded-b-[50px] h-[92.2vh] overflow-hidden bg-[#f6f6f6]">
      <div
        id="header-hero"
        className="absolute z-200000 top-[25%] left-0 right-0 ms-auto me-auto w-fit align-middle text-center bg-radial-custom"
      >
        <p className="text-[#438fff] font-square-peg text-[calc(1.5rem+1vw)]">
          Mastering agility, optimizing efficiency
        </p>
        <h1 className="font-rubik text-[calc(1.1rem+3.9vw)] font-[600] leading-tight bg-gradient-to-t from-[#000e23] via-[#042350] via-40% to-[#002c6d] inline-block text-transparent bg-clip-text">
          Harnessing Agility for
          <br />
          Efficient Product Delivery
        </h1>
        <div className="flex flex-col justify-center items-center font-rubik text-xl text-[#000e23] font-[350] pt-3">
          ...
          <div className="flex flex-row justify-around gap-3 mt-5">
            ...
            <ContactButton variant="outlined" label="Contact me" />
          </div>
        </div>
      </div>
