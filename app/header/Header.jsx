    ...
    <>
      ...
      <div ref={headerRef} id="go-to-top">
        <motion.nav
          ...
          className="top-0 right-0 left-0 z-[100] max-h-[70px] py-2 px-4 scroll-mb-0 sm:fixed backdrop-blur-[12px] bg-[rgba(255,255,255,.7)] max-sm:bg-white sm:backdrop-blur-[12px]"
        >
